...
*/}}
{{- define "perses-operator.fullname" -}}
...
*/}}
{{- define "perses-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "perses-operator.resourceName" -}}
{{- $fullname := include "perses-operator.fullname" .context }}
{{- $suffix := .suffix }}
